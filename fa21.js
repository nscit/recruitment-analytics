 ...
 * 
 * JavaScript code to render demographic breakdown charts of the Fall 2021
 * recruitment cycle for the UT Natural Sciences Council.
 */
let charts = [];

// demographic groups evaluated as of Fall 2021
const groups = [
    "ethnoracial",
    "gender",
    "major",
...
const semester = "fa21";
const databaseVersion = "4.0.1";
const databaseURL = "https://cdn.jsdelivr.net/gh/UT-Natural-Sciences-Council/database@" + databaseVersion + "/fa21-portal-";
